...
> **Note**: Platform publishing (e.g. Fanqie, Yuewen) and AI Drama features have their backend logic removed; the frontend buttons remain visible but are disabled.
...
| AI Drama Factory | 🔒 Coming Soon | Storyboard generation and voice synthesis |
| Platform Publishing | 🔒 Coming Soon | One-click publish to major novel platforms |
